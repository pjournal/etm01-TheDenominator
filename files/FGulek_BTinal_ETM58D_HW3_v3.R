...
matches_modyear3$V5=as.numeric(matches_modyear3$V5)
matches_modyear3$month=as.numeric(matches_modyear3$month)
matches_modyear3$Season <- ifelse(matches_modyear3$month >=7, matches_modyear3$V5+1, matches_modyear3$V5)
